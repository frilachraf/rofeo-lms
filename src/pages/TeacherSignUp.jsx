...
import { Home, Mail, User, Lock, BookOpen, Image } from 'lucide-react';
...
const TeacherSignUp = () => {
  ...
  const handleAvatarChange = (e) => {
    if (e.target.files && e.target.files[0]) {
      ...
      // Optionally, set a preview URL here if needed for display
    }
  };
          ...
          <Card className="shadow-lg">
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-center">
                Créez votre compte enseignant pour partager vos connaissances
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  ...
                  <div className="relative">
                    <BookOpen className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground h-4 w-4" />
                    <Input
                      id="expertise"
                      name="expertise"
                      type="text"
                      ...
                      onChange={handleChange}
                      disabled={isLoading}
                      className={`pl-9 transition-all focus:ring-2 focus:ring-primary ${errors.expertise ? 'border-red-500' : ''}`}
                    />
                  </div>
                ...
                >
                  ...
                  <Textarea
                    id="bio"
                    name="bio"
                    placeholder="Parlez-nous de vous et de votre approche pédagogique..."
                    onChange={handleChange}
                    disabled={isLoading}
                ...
                >
                  <Button 
                    ...
                    disabled={isLoading}
                  >
                    {isLoading ? 'Création du compte...' : 'Créer un compte enseignant'}
                  </Button>
                </motion.div>
              </form>
            </CardContent>
