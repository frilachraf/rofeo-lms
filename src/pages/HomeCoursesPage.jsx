...
export default function HomeCoursesPage() {
  ...
  const handleEnroll = async (courseId,teacherId) => {
    try {
      ...
      toast.success("Cours inscrit avec succès");
  ...
  return (
    <div className="container mx-auto p-8">
      <div className="flex flex-col items-center gap-6">
        ...
        Découvrez une large gamme de cours dispensés par des formateurs experts. Trouvez le cours idéal pour atteindre vos objectifs d'apprentissage.
        </p>
