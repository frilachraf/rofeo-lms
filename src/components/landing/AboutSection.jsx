...
//       <div className="max-w-5xl mx-auto mt-10 grid md:grid-cols-2 gap-10 items-center">
//         <img
//           src="https://qwcxskzpvafmhfczdscy.supabase.co/storage/v1/object/public/rofeofiles/landingpage/PIC2.jpg"
//           alt="Présentation"
...
//           <p className="mb-4">
//             Offrir une formation accessible, encadrée par des experts, pour permettre à chacun de créer son propre projet en robotique.
//           </p>
//           <h3 className="text-2xl font-bold mb-3 text-red-300">🎯 Nos Objectifs</h3>
//           <ul className="list-disc list-inside space-y-2">
//             <li>Apprendre à programmer des robots (Thymio, Bibot, mBot...)</li>
//             <li>Maîtriser Scratch, VPL et Arduino</li>
//             <li>Créer un robot de A à Z</li>
//             <li>Se préparer pour un PFE en robotique ou enseigner plus efficacement</li>
//           </ul>
//         </div>
//       </div>
...
//           <img
//             src="https://qwcxskzpvafmhfczdscy.supabase.co/storage/v1/object/public/rofeofiles/landingpage/PIC4.jpg"
//             alt="Robot 1"
//             className="rounded-lg shadow-md object-cover h-40 w-full"
//           />
//           <img
//             src="https://qwcxskzpvafmhfczdscy.supabase.co/storage/v1/object/public/rofeofiles/landingpage/PIC3.jpg"
//             alt="Robot 2"
//             className="rounded-lg shadow-md object-cover h-40 w-full"
//           />
//           <img
//             src="https://qwcxskzpvafmhfczdscy.supabase.co/storage/v1/object/public/rofeofiles/landingpage/PIC1.jpg"
//             alt="Robot 3"
//             className="rounded-lg shadow-md object-cover h-40 w-full"
//           />
//           <img
//             src="https://qwcxskzpvafmhfczdscy.supabase.co/storage/v1/object/public/rofeofiles/landingpage/PIC5.jpg"
//             alt="Robot 4"
//             className="rounded-lg shadow-md object-cover h-40 w-full"
//           />
//         </div>
...
// // export const AboutSection = () => {
// //   return (
// //     <section className="w-full bg-yellow-600 text-white py-16 px-6">
// //       <div className="max-w-5xl mx-auto text-center">
// //         <h2 className="text-4xl font-bold mb-6">🎓 Qui sommes-nous ?</h2>
// //         <p className="text-lg mb-4">
// //           <strong>ROFEO Academy</strong> est une académie spécialisée dans la <strong>formation en robotique</strong> pour tous les niveaux : élèves, étudiants, enseignants ou passionnés.
...
// //       </div>
// //       <div className="max-w-5xl mx-auto mt-10 grid md:grid-cols-2 gap-10 items-center">
// //         <img src="https://qwcxskzpvafmhfczdscy.supabase.co/storage/v1/object/public/rofeofiles/landingpage/PIC2.jpg" alt="Présentation" className="rounded-xl shadow-md" />
// //         <div>
// //           <h3 className="text-2xl font-bold mb-3">🤖 Notre Mission</h3>
// //           <p className="mb-4">
// //             Offrir une formation accessible, encadrée par des experts, pour permettre à chacun de créer son propre projet en robotique.
...
// // // export const AboutSection = () => {
// // //   return (
// // //     <section id="about" className="py-16 bg-gray-100 w-full">
// // //       <div className="container mx-auto px-4 text-center">
// // //         <h2 className="text-3xl font-bold mb-6">Qui sommes-nous ?</h2>
// // //         <p className="text-gray-700 max-w-3xl mx-auto">
// // //           ROFEO Academy est une académie spécialisée dans la formation en robotique
// // //           pour enfants, étudiants, enseignants et passionnés. Notre mission est de
// // //           démocratiser l'apprentissage de la technologie et de la programmation
// // //           grâce à des cours interactifs, ludiques et progressifs.
// // //         </p>
// // //       </div>
// // //     </section>
// // //   );
